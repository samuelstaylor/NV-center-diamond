...
ezpl = 1.831592 * 1000 # set this to the zpl found in analyze.out
spectrum_pl_dis = pl_use_dis.compute_spectrum(ezpl, spectrum_type='PL', lineshape=lineshape_fft_pl_dis)
